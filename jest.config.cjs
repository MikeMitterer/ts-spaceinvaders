...
module.exports = {
  // cache: false,
    ...
    //
    // Ist das nicht gesetzt kommt die Meldung:
    //     jest-haste-map: Haste module naming collision: ...
    // Ursache ist dass mehrere package.json-Files existieren
  ...
  //
    ...
    //    So essentially we want to ignore the following
    //    files: "everything in node_modules except for @mmit..., vuetify, @mdi, uuid"
    transformIgnorePatterns: [
        '<rootDir>/node_modules/(?!(@mmit|vuetify|@mdi|uuid)/.*)'
    ],
